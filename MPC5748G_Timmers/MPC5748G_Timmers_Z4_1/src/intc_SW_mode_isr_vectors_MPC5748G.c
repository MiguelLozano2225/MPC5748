...
/*========================================================================*/
void dummy 						  (void);
extern void STM0_CH0_isr		  (void);
extern void STM1_CH0_isr		  (void);
...
(uint32_t) &STM0_CH0_isr, /* Vector #  36 On-Platform periodic timer 0_0 (STM) STM_0_CIR0[CIF] */
...
(uint32_t) &STM1_CH0_isr, /* Vector #  40 On-Platform periodic timer 1_0 (STM) STM_1_CIR0[CIF] */
